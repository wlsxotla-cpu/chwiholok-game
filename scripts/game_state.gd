...
const VERSION := "v0.10.0 · 2026-09-09"
...
const META_DEFS := {
	...
	"revive": {"name": "환생술", "desc": "사망 시 자동 부활 +1회 (체력 절반으로 부활)", "base_cost": 250, "max_level": 3},
}
...
var meta_upgrades: Dictionary = {"hp": 0, "dmg": 0, "move": 0, "pickup": 0, "revive": 0}
